...
|------------|-------------|----------------------|-------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| Akeneo     | 4.0 Apache  | `akeneo:4.0-apache`  |[artifakt-io/base-akeneo](https://github.com/artifakt-io/base-akeneo/tree/4.0)       | ![akeneo:4.0-apache](https://res.cloudinary.com/artifakt/image/upload/v1/akeneo_4.0-status.svg)   | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/akeneo_4.0-size.svg)  |
| Akeneo     | 5.0 Apache  | `akeneo:5.0-apache`  |[artifakt-io/base-akeneo](https://github.com/artifakt-io/base-akeneo/tree/5.0)       | ![akeneo:5.0-apache](https://res.cloudinary.com/artifakt/image/upload/v1/akeneo_5.0-status.svg)   | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/akeneo_5.0-size.svg)  |
...
| Drupal     | 9.2 Apache  | `drupal:9.2-apache`  |[artifakt-io/base-drupal](https://github.com/artifakt-io/base-drupal/tree/9.2)       | ![drupal:9.2-apache](https://res.cloudinary.com/artifakt/image/upload/v1/drupal_9.2-status.svg)   | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/drupal_9.2-size.svg)  |
...
| Magento    | 2.4         | `magento:2.4-apache` |[artifakt-io/base-magento](https://github.com/artifakt-io/base-magento/tree/2.4)     | ![magento:2.4](https://res.cloudinary.com/artifakt/image/upload/v1/magento_2.4-status.svg)        | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/magento_2.4-size.svg) |
| Node.js    | 12          | `node:12`            |[artifakt-io/base-nodejs](https://github.com/artifakt-io/base-nodejs)                | ![Node.js 12](https://res.cloudinary.com/artifakt/image/upload/v1/nodejs_12-status.svg)           | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/nodejs_12-size.svg)   |
| Node.js    | 14          | `node:14`            |[artifakt-io/base-nodejs](https://github.com/artifakt-io/base-nodejs)                | ![Node.js 14](https://res.cloudinary.com/artifakt/image/upload/v1/nodejs_14-status.svg)           | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/nodejs_14-size.svg)   |
...
| PHP        | 7.3 Apache  | `php:7.3-apache`     |[artifakt-io/base-php](https://github.com/artifakt-io/base-php/tree/7.3)             | ![PHP 7.3](https://res.cloudinary.com/artifakt/image/upload/v1/php_7.3-status.svg)                | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/php_7.3-size.svg)     |
| PHP        | 7.4 Apache  | `php:7.4-apache`     |[artifakt-io/base-php](https://github.com/artifakt-io/base-php/tree/7.4)             | ![PHP 7.4](https://res.cloudinary.com/artifakt/image/upload/v1/php_7.4-status.svg)                | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/php_7.4-size.svg)     |
| PHP        | 8.0 Apache  | `php:8.0-apache`     |[artifakt-io/base-php](https://github.com/artifakt-io/base-php/tree/8.0)             | ![PHP 8.0](https://res.cloudinary.com/artifakt/image/upload/v1/php_8.0-status.svg)                | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/php_8.0-size.svg)     |
...
| Sylius     | 1.10 Apache | `sylius:1.10-apache` |[artifakt-io/base-sylius](https://github.com/artifakt-io/base-sylius/tree/1.10)      | ![sylius:1.10-apache](https://res.cloudinary.com/artifakt/image/upload/v1/sylius_1.10-status.svg) | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/sylius_1.10-size.svg) |
| Symfony    | 4.4 Apache  | `symfony:4.4-apache` |[artifakt-io/base-symfony](https://github.com/artifakt-io/base-symfony/tree/4.4)     | ![symfony:4.4-apache](https://res.cloudinary.com/artifakt/image/upload/v1/symfony_4.4-status.svg) | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/symfony_4.4-size.svg) |
| Symfony    | 5.3 Apache  | `symfony:5.3-apache` |[artifakt-io/base-symfony](https://github.com/artifakt-io/base-symfony/tree/5.3)     | ![symfony:5.3-apache](https://res.cloudinary.com/artifakt/image/upload/v1/symfony_5.3-status.svg) | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/symfony_5.3-size.svg) |
...
| Wordpress  | 5 Apache    | `wordpress:5-apache` |[artifakt-io/base-wordpress](https://github.com/artifakt-io/base-wordpress/tree/5.7) | ![wordpress:5-apache](https://res.cloudinary.com/artifakt/image/upload/v1/wordpress_5-status.svg) | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/wordpress_5-size.svg) |
