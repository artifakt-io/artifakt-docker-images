...
| Golang     | 1.16        | `golang:1.16`        |[artifakt-io/base-go](https://github.com/artifakt-io/base-go/tree/main)              | ![golang:1.16](https://res.cloudinary.com/artifakt/image/upload/v1/golang_1.16-status.svg)               | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/golang_1.16-size.svg)        |
| Golang     | 1.18        | `golang:1.18`        |[artifakt-io/base-go](https://github.com/artifakt-io/base-go/tree/main)              | ![golang:1.18](https://res.cloudinary.com/artifakt/image/upload/v1/golang_1.18-status.svg)               | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/golang_1.16-size.svg)        |
...
| Ruby       | 3.1         | `ruby:3.1`           |[artifakt-io/base-ruby](https://github.com/artifakt-io/base-ruby)                    | ![ruby:3.1](https://res.cloudinary.com/artifakt/image/upload/v1/ruby_3.1-status.svg)                     | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/ruby_3.1-size.svg)           |
...
| Symfony    | 5.4 Apache  | `symfony:5.4-apache` |[artifakt-io/base-symfony](https://github.com/artifakt-io/base-symfony/tree/5.4)     | ![symfony:5.4-apache](https://res.cloudinary.com/artifakt/image/upload/v1/symfony_5.4-apache-status.svg) | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/symfony_5.4-apache-size.svg) |
