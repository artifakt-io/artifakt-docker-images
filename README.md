...
| Magento    | 2.4 FPM     | `magento:2.4`        |[artifakt-io/base-magento](https://github.com/artifakt-io/base-magento/tree/2.4-fpm) | ![magento:2.4-fpm](https://res.cloudinary.com/artifakt/image/upload/v1/magento_2.4-fpm-status.svg)       | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/magento_2.4-fpm-size.svg)    |
