...
| Angular    | 12          | `angular:12`         |[artifakt-io/base-angular](https://github.com/artifakt-io/base-angular)              | ![angular:12](https://img.shields.io/badge/angular_12-passing-green)                 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
...
| Golang     | 1.16        | `golang:1.16`        |[artifakt-io/base-golang](https://github.com/artifakt-io/base-golang)                | ![golang:1.16](https://img.shields.io/badge/golang_1.16-passing-green)               | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
...
| Nuxtjs     | 2.15        | `nuxtjs:2.15`        |[artifakt-io/base-nuxtjs](https://github.com/artifakt-io/base-nuxtjs)                | ![Nuxtjs 2.15](https://img.shields.io/badge/nuxtjs_2.15-passing-green)               | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
...
| VueJs      | 3           | `vuejs:3`            |[artifakt-io/base-vuejs](https://github.com/artifakt-io/base-vuejs)                  | ![wordpress:vuejs](https://img.shields.io/badge/vuejs_3-passing-green)               | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
