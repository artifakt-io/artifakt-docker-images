...
| Akeneo     | 5.0 Apache | `akeneo:5.0-apache`  |[artifakt-io/base-akeneo](https://github.com/artifakt-io/base-akeneo/tree/4.0)     | ![akeneo:5.0-apache](https://img.shields.io/badge/akeneo_5.0-passing-green)          | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
| Drupal     | 8.9 Apache | `drupal:8.9-apache`  |[artifakt-io/base-drupal](https://github.com/artifakt-io/base-drupal/tree/8.9)     | ![drupal:8.9-apache](https://img.shields.io/badge/drupal_8.9-passing-green)          | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
| Drupal     | 9.1 Apache | `drupal:9.1-apache`  |[artifakt-io/base-drupal](https://github.com/artifakt-io/base-drupal/tree/9.1)     | ![drupal:9.1-apache](https://img.shields.io/badge/drupal_9.1-passing-green)          | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
...
| Magento    | 2.4        | `magento:2.4-apache` |[artifakt-io/base-magento](https://github.com/artifakt-io/base-magento/tree/2.4.2) | ![magento:2.4](https://img.shields.io/badge/magento_2.4-passing-green)               | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
...
| PHP        | 7.3 FPM    | `php:7.3-fpm`        |[artifakt-io/base-php](https://github.com/artifakt-io/base-php/tree/7.3)           | ![PHP 7.3](https://img.shields.io/badge/php_7.3_fpm-passing-green)                   | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
...
| PHP        | 7.4 FPM    | `php:7.4-fpm`        |[artifakt-io/base-php](https://github.com/artifakt-io/base-php/tree/7.4)           | ![PHP 7.4](https://img.shields.io/badge/php_7.4_fpm-passing-green)                   | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
...
| PHP        | 8.0 FPM    | `php:8.0-fpm`        |[artifakt-io/base-php](https://github.com/artifakt-io/base-php/tree/8.0)           | ![PHP 8.0](https://img.shields.io/badge/php_8.0_fpm-passing-green)                   | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
...
| Symfony    | 5.2 FPM    | `symfony:5.2-fpm`    |[artifakt-io/base-symfony](https://github.com/artifakt-io/base-symfony/tree/5.2)   | ![symfony:5.2-fpm](https://img.shields.io/badge/symfony_5.2_fpm-passing-green)       | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
| Symfony    | 5.2 Apache | `symfony:5.2-apache` |[artifakt-io/base-symfony](https://github.com/artifakt-io/base-symfony/tree/5.2)   | ![symfony:5.2-apache](https://img.shields.io/badge/symfony_5.2_apache-passing-green) | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
| Wordpress  | 5 Apache   | `wordpress:5-apache` |[artifakt-io/base-wordpress](https://github.com/artifakt-io/base-wordpress/5.7) | ![wordpress:5-apache](https://img.shields.io/badge/wordpress_5_apache-passing-green) | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/library/php/8.0) |
