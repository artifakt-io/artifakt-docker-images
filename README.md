...
|------------|-------------|----------------------|-------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| Akeneo     | 4.0 Apache  | `akeneo:4.0-apache`  |[artifakt-io/base-akeneo](https://github.com/artifakt-io/base-akeneo/tree/4.0)       | ![akeneo:4.0-apache](https://res.cloudinary.com/artifakt/image/upload/v1/akeneo_4.0-apache-status.svg)   | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/akeneo_4.0-apache-size.svg)  |
| Akeneo     | 5.0 Apache  | `akeneo:5.0-apache`  |[artifakt-io/base-akeneo](https://github.com/artifakt-io/base-akeneo/tree/5.0)       | ![akeneo:5.0-apache](https://res.cloudinary.com/artifakt/image/upload/v1/akeneo_5-apache-status.svg)     | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/akeneo_5.0-apache-size.svg)  |
...
| Node.js    | 12          | `node:12`            |[artifakt-io/base-nodejs](https://github.com/artifakt-io/base-nodejs)                | ![Node.js 12](https://res.cloudinary.com/artifakt/image/upload/v1/node_12-status.svg)                    | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/node_12-size.svg)            |
...
| PHP        | 7.3 Apache  | `php:7.3-apache`     |[artifakt-io/base-php](https://github.com/artifakt-io/base-php/tree/7.3)             | ![PHP 7.3](https://res.cloudinary.com/artifakt/image/upload/v1/php_7.3-apache-status.svg)                | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/php_7.3-apache-size.svg)     |
...
| PHP        | 8.0 Apache  | `php:8.0-apache`     |[artifakt-io/base-php](https://github.com/artifakt-io/base-php/tree/8.0)             | ![PHP 8.0](https://res.cloudinary.com/artifakt/image/upload/v1/php_8.0-apache-status.svg)                | ![Docker Image Size (tag)](https://res.cloudinary.com/artifakt/image/upload/v1/php_8.0-apache-size.svg)     |
